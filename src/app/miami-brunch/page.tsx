      ...
      <main className="brunch-page">
        ...
        <section id="brunch-banner" className="brunch-banner-section">
          <div className="parallax-background">
            <img
              loading="eager" decoding="async" fetchPriority="high" src="https://verdey-nyc.s3.eu-north-1.amazonaws.com/images/_40A8503.jpg"
          ...
          <div className="content-wrapper">
            ...
            <div className="brunch-image-card right">
              <div className="image-card-image">
                <img 
                  loading="lazy" decoding="async" src="https://verdey-nyc.s3.eu-north-1.amazonaws.com/images/_40A8515.jpg"
            ...
            <div className="brunch-image-card left">
              <div className="image-card-image">
                <img
                  loading="lazy" decoding="async" src="https://verdey-nyc.s3.eu-north-1.amazonaws.com/images/_40A8519.jpg"
