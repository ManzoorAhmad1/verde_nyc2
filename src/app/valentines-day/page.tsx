      ...
      <main className="valentines-page">
        ...
        <section id="valentines-banner" className="valentines-banner-section">
          <div className="parallax-background">
            <img
              loading="eager" decoding="async" fetchPriority="high" src="https://verde-nyc-s3.s3.eu-north-1.amazonaws.com/images/_40A8521.jpg"
          ...
          <div className="content-wrapper text-[#A5A39A]">
            ...
            <div className="venue-section">
              ...
              <div className="venue-image-wrapper max-w-2xl mx-auto">
                <img
                  loading="lazy" decoding="async" src="https://verde-nyc-s3.s3.eu-north-1.amazonaws.com/images/_40A8522.jpg"
            ...
            <div className="venue-section">
              ...
              <div className="venue-image-wrapper max-w-2xl mx-auto">
                <img
                  loading="lazy" decoding="async" src="https://verde-nyc-s3.s3.eu-north-1.amazonaws.com/images/_40A8523.jpg"
