    ...
    <main className="lounge-page">
      ...
      <section id="programme" className="lounge-programme-section">
        <div className="lounge-programme-inner">
          <h2>DJ Programming in New York City</h2>
          <p>Discover our thoughtfully curated DJ lineup, featuring a blend of resident and guest artists who set the tone for unforgettable evenings in our lounge.</p>
      ...
      <section id="miami-art-week-tshirts-ml" className="lounge-tshirts-section">
        <div className="lounge-tshirts-header">
          <h2>VERDE LOUNGE<br />Winter Lineup T-SHIRTS</h2>
          <p>This limited-edition T-shirt celebrates the Winter Lineup at VERDE LOUNGE, creating a magnetic musical journey that channeled the essence of Mediterranean winter.</p>
          <hr />
        </div>
        ...
        <div className="lounge-tshirts-content">
          ...
          <div className="lounge-tshirts-details">
            <h2>Winter Lineup T-Shirt - Limited Edition</h2>
            
            <h3><strong>Description</strong></h3>
            <p className="indented">100 % premium cotton - Classic fit - Black</p>
            
            <h3><strong>Sizes</strong></h3>
            <p className="indented">Small (S) - Medium (M) - Large (L) (runs small)</p>
            
            <h3><strong>Shipping Options</strong></h3>
            <p className="indented"><strong>Shipping via FedEx:</strong> Flat rate - $10.95 within the U.S (3 business days delivery)</p>
            <p className="indented"><strong>Local Pick-Up:</strong> Available to pick-up at <Link href="https://maps.app.goo.gl/QBRTBSPuh96ZhnFH9" target="_blank">Verde NYC</Link> (2 business days after purchase).</p>
            <p className="indented">Pick-Up hours: Tuesday to Sunday: 6:00 PM – 10:00 PM and Saturday &amp; Sunday: 11:30 AM – 4:00 PM.</p>
            <p className="indented">Your confirmation email will be requested to pick your order.</p>
            <p className="indented">Orders not picked up within <strong>14 days</strong> will be forfeited without refund.</p>
            
            <h3><strong>Return &amp; Refund Policy</strong></h3>
            <p className="indented">All sales are final. We do not accept returns, exchanges, or offer refunds once an order has been placed.</p>
            
            <p><strong>*For Presale, T-Shirts will be available to ship December 1st.</strong></p>
      ...
      <section id="milaloungevibes" className="lounge-vibes-section">
        <div className="lounge-vibes-inner">
          <h3>HOURS</h3>
          <p>Wednesday - Saturday: 6:30 pm – 4 am</p>
          <p>Follow Verde Lounge journey on <Link href="https://www.instagram.com/verdenyc/" target="_blank">Instagram</Link></p>
