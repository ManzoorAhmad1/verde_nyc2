      ...
      <section id="contact-info" className="contact-info">
        <div className="contact-info-content">
          ...
          <div className="contact-social-icons">
            ...
            <a href="https://www.facebook.com/milagroupmiami" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              <svg viewBox="0 0 64 64" width="32" height="32">
            ...
            <a href="https://www.instagram.com/milagroup_miami" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <svg viewBox="0 0 64 64" width="32" height="32">
